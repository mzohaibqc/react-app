This project contains code that was built while learning React. It contains a single page with a currency converter and lists of posts those can be filtered using 
